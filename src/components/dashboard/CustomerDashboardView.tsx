...
export default function CustomerDashboardView({ userData: initialUserData, orders }: any) {
  ...
  const handleAddToBasket = (e: React.MouseEvent, item: any) => {
    ...
    // UPDATED: Capture coordinates for the global flying effect
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="grid lg:grid-cols-[280px_1fr] gap-8">
        ...
        <main className="bg-white rounded-[4rem] shadow-sm border border-stone-200 min-h-[700px]">
                        ...
                        <div className="w-full h-full bg-white rounded-3xl overflow-hidden relative">
                          ...
                          {!isSoldOut && (
                            <div className="absolute inset-0 z-20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/10">
                              <button onClick={(e) => handleAddToBasket(e, item)} className="bg-white text-slate-900 px-4 py-2 rounded-full font-black uppercase text-[8px] tracking-widest flex items-center gap-2 shadow-xl hover:bg-[#b32d3a] hover:text-white transition-all active:scale-90">
